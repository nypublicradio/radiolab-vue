              ...
              <div class="col">
                <div v-if=" dataLoaded " class="episode flex">
                  ...
                  <v-image-with-caption
                    ...
                    :alt=" episode[ 'image-main' ][ 'alt-text' ] " :width=" isMobile ? 90 : 200 "
                    :height=" isMobile ? 90 : 200 " :max-width=" episode[ 'image-main' ].w "
                    :max-height=" episode[ 'image-main' ].h " :ratio=" [ 1, 1 ] " class="episode-image" />
