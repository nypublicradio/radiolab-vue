<template>
  <svg
    ...
    x="0px"
    y="0px"
    viewBox="0 0 1255 248"
    style="enable-background:new 0 0 1255 248;"
    xml:space="preserve"
  >
    <g>
      <path
        id="r"
        class="st0"
        d="M119.1,132.4c26.9-9.3,43.2-31.2,43.2-59.8C162.3,33.6,133.4,8,89.1,8H5.4v232.7h30.2V137h51.5
		l64.5,103.7h34.6L119.1,132.4z M85.8,109.8H35.6V35h50.2c28.6,0,45.5,14,45.5,37.6S114.4,109.8,85.8,109.8z"
      />
      <path
        id="a"
        class="st0"
        d="M269.7,70.5c-35.2,0-62.8,21.6-67.8,54.8l26.3,5c2.3-22.6,18.6-36.2,41.6-36.2
      ...
      <path
        id="d"
        class="st0"
        d="M506.8,5.4v91.7c-10.6-15.6-32.6-26.6-54.8-26.6c-51.9,0-80.4,37.2-80.4,86.4
      ...
      <g id="i">
        <path
          class="st0"
          d="M591.4,41.6c11.6,0,20.3-8.6,20.3-19.6c0-11.3-8.6-19.9-20.3-19.9c-11.3,0-19.6,8.6-19.6,19.9
      ...
      <path
        id="o"
        class="st0"
        d="M723.6,70.5c-49.9,0-85.1,36.2-85.1,86.4s35.2,86.4,85.1,86.4c49.5,0,85.4-36.2,85.4-86.4
      ...
      <path
        id="a2"
        class="st0"
        d="M975,70.5c-35.2,0-62.8,21.6-67.8,54.8l26.3,5c2.3-22.6,18.6-36.2,41.6-36.2
		c24.6,0,40.9,14.6,40.9,37.6v3.3l-32.6,3.7c-53.5,5.3-79.8,22.9-79.8,55.2c0,28.9,22.9,49.5,56.5,49.5c24.3,0,46.2-12,55.8-31.2
      ...
      <path
        id="b"
        class="st0"
        d="M1169.6,70.5c-22.3,0-44.2,11-54.8,26.6V5.4h-28.3v235.4h28.3v-24.3c7.6,15.3,29.9,26.9,54.5,26.9
